...
var deneme = function(webPageName, chipId){
	sensorObject.call(this);
	this.webPageName = webPageName;
	this.chipId = chipId;
}

deneme.prototype = Object.create(sensorObject.prototype);
deneme.prototype.constructor = deneme;

deneme.prototype.calling = function(){
	console.log('Hi, I am '+ this.chipId + ' and ' + this.webPageName);
	databaseToWeb(this.webPageName,this.chipId);
}

var siktir = new deneme('/pageofSensor1','/8794332'+'s1');
...
client.on('connect', function () {
  	//sensor1
  	client.subscribe('/data' + '/8794332'+'s1')
  	//sensor2
...
//databaseToWeb(sensorObject1.webPageName,sensorObject1.chipId);
databaseToWeb(sensorObject2.webPageName,sensorObject2.chipId);
databaseToWeb(sensorObject3.webPageName, sensorObject3.chipId);
