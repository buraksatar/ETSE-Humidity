...
databaseToWeb(
	...
	sensorObject1.sensorQueue);
databaseToWeb(
	sensorObject2.databaseTableName, 
	sensorObject2.webPageName, 
	sensorObject2.chipId,
	sensorObject2.sensorQueue);
databaseToWeb(
	sensorObject3.databaseTableName, 
	sensorObject3.webPageName, 
	sensorObject3.chipId,
	sensorObject3.sensorQueue);


function databaseToWeb(tableNameOfSensor, pageNameOfSensor, chipIDofSensor, sensorQueue) {
	//making connection with sensor1 table in Database
		...
		app.get(pageNameOfSensor, function(req, res) {
			...
			// message is Buffer
				...
				var deneme1 = chipIDofSensor.slice(-1);
				var deneme2 = pageNameOfSensor.slice(-1);
