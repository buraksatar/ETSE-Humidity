...
--    sendreport(currMeasure,currMUX,0)
    ...
    denemeVar=t/10
        local buf = "";
        buf = buf.."<head><style>.city {float: left; margin: 5px; padding: 15px; max-width: 300px; height: 300px; border: 1px solid black;} </style></head>"       
        buf = buf.."<div class=city><h1> ESP8266 Web Server</h1>";
--        buf = buf.."<p>GPIO0 <a href=\"?pin=ON1\"><button>ON</button></a>&nbsp;<a href=\"?pin=OFF1\"><button>OFF</button></a></p>";
--        buf = buf.."<p>GPIO2 <a href=\"?pin=ON2\"><button>ON</button></a>&nbsp;<a href=\"?pin=OFF2\"><button>OFF</button></a></p>";
        buf = buf.."<table style=width:25%><tr><th>Data Type</th><th>Valueame</th></tr>"
        buf = buf.."<tr><td>Temperature</td><td>"..denemeVar.."</td></tr></table></div>"
